  ...
  .addFields(
    {
      ...
      value: `You've probably already guessed the theme of this contest from the subheader above, and as such, our monthly contest has expanded from having a sole focus on art, to allowing a ton of potential options to its entrants.\nWhether you still want to focus on drawing, make a cover of a previous song, or write a whole thesis on ZUTOMAYO lore, the possibilities are ~~somewhat~~ endless!\n${emojis.spacer}`,
    },
    {
...
export const contest2 = new MessageEmbed().setColor('#F1D8F7').addFields(
  {
    name: 'Category #1: Art',
    value:
      "With our contest theme this month being so broad, you can really draw whatever you'd like, as long as it relates to ZUTOMAYO and/or the ZONE in some way.\nLost on where to even start? Try using one of these prompts: What does ZUTOMAYO mean to you?; What's your favourite song, who's your favourite Nira, which MV do you love the most, etc...?\nAny and all mediums will be accepted, however please make sure the quality is high enough (960x540 __minimum__) to be used as our server banner for the month if you win!",
  },
  {
    name: 'Category #2: Music',
    value:
      "Whether you're a cover artist with a stunning voice, or a prodigy with skill in any instrument, we'd love to see your takes on ZUTOMAYO's work!\nPlease submit your entry as either a video or audio file that you're happy with others hearing, as all our contests are judged by our server's members themselves!",
  },
  {
    name: 'Category #3: Writing',
    value:
      "The most broad category in our already-broad theme; The writing category of our contest entails reviews, theories, translations, fanfiction, and even coding!\nNow's the time to prove yourself as a true master of ZUTOMAYO lore (maybe even using your own translations), a respectable stan capable of writing a review fit for a music magazine (which you can even film, if you'd like!), an author with a best-selling angsty Grey x Nira fanfic, or even one of <@740606402330099752>'s developers by writing a new feature you'd think would be perfect for the ZONE (using js)!\nJust remember to note that entries for this category must be provided as a link to a public/unlisted file, such as a PDF, or .txt file hosted online.",
  },
);
  ...
  .addFields(
    {
      name: 'Plaigarism',
      value:
        'Any form of plaigarism, such as direct tracing for art entries, or even submitting straight-up stolen work for any of the categories will result in immediate disqualification.',
    },
    {
      name: 'Restrictions',
      value:
        "We'd prefer original entries made solely for this contest, but there is no restriction on art previously created/entered into other competitions.",
    },
  );
