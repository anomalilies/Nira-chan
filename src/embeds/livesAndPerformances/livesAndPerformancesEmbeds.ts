...
export const livesAndPerformances1 = new MessageEmbed()
  ...
  .addFields(
    ...
    },
    {
      ...
      value:
        '**[Download Link](https://mega.nz/file/abQnHQpZ#JB1sN4qVS9MCHCGUw0Mz0mzJdEbOopu3N8h41bC5RSk)** ([Mirror](https://drive.google.com/file/d/1yDwELl6mAggdViqajabl1QOO6NMspHYl/view?usp=sharing))\nAudio-only: [MP3](https://drive.google.com/drive/folders/1Qs9uNdTLwi7rrMey9y4OFSoN6m-sgaSm?usp=sharing)',
    },
    {
      name: 'Midnight Forever Live from YouTube Space Tokyo',
      value:
        '**[YouTube Link](https://youtu.be/PwVFxexqenE)** ([Mirror 1](https://mega.nz/file/LeBGwABR#ev4H4Ha9pKXaytiCg7fXH_30rzoeN6147ys22h7P90s) | [Mirror 2](https://drive.google.com/file/d/1-cv5b44qK_vWnPo-tgAYybuB_6CjuNpb/view?usp=sharing))\nAudio-only: [MP3](https://drive.google.com/drive/folders/1Z0FW3ygYTzIortW18LhHkqZfQ67DmJnD?usp=sharing)',
    },
    {
      name: 'Bathroom Twin Piano Live',
      value:
        '**[Download Link](https://mega.nz/file/fGw1ATgY#s0CporJqz0MHK7QAH1NhS1pQAjk72R-WXqqFMiSd_rk)** ([Mirror](https://drive.google.com/file/d/1UHbhdbDBPe2IDLW7utznj1PegJoEiHDg/view?usp=sharing))\nAudio-only: [MP3](https://drive.google.com/drive/folders/1uHT69XHUNTSCLCk4qb8x7rTYDks8NCld?usp=sharing)',
    },
    {
      name: 'FUJI ROCK FESTIVAL 2019',
      value:
        '**[Download Link](https://mega.nz/file/rXQB0arY#O5IoHE1kre58krNLoO_qKQ3TcNc1xKa12hr_vqx87oM)** ([Mirror](https://drive.google.com/file/d/1awTe-vcZrqK5gJWmM0SgDjQgL057CNsW/view?usp=sharing))\nAudio-only: [MP3](https://drive.google.com/drive/folders/1wsBOIe4zt8RYKyY5e9-TZ4kdCkcJBVeL?usp=sharing)',
    },
    {
...
export const livesAndPerformances2 = new MessageEmbed().setTitle('Scans').setColor('#F1D8F7').addFields(
  {
    name: 'Hisohiso Banashi: Band Score',
    value:
      '**[Download Link](https://drive.google.com/drive/folders/1iyKuqs4dfOoYcRAlKvAnbgWCVU_DK5En?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/1vkVTM5w-ftEit4f138YSqpE7NamEc9r4?usp=sharing))',
  },
  {
    name: 'Hisohiso Banashi: Limited Edition Booklet',
    value:
      '**[Download Link](https://drive.google.com/drive/folders/16Qljz7LZk2rOAA9vZNRkBjZv7f5KwQJm?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/1IZeEG3gJuHpDTZbLD2z9ph_nx8dB5ese?usp=sharing))',
  },
  {
    name: 'Hogaraka na Hifutote Fufuku: Limited Edition Booklet',
    value:
      '**[Download Link](https://drive.google.com/drive/folders/1VzqAAmpBZ96iMiO3dcw9HnhbErng985u?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/18WlEyI6q1FPvkrZf8oCVUIkb0Lh8zDv8?usp=sharing))',
  },
);

export const livesAndPerformances3 = new MessageEmbed().setTitle('Music').setColor('#F1D8F7').addFields(
  { name: 'Official Instrumentals', value: '**[Download Link](https://piapro.jp/zutomayo)**' },
  {
    name: "ACAね's Song Covers",
    value: '**[Download Link](https://drive.google.com/drive/folders/1k6SJ4cH4CGEbbIIA-jIw2t47ebUi-dwl?usp=sharing)**',
  },
  {
