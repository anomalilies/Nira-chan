...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) => option.setName("input").setDescription("Who you want to obsess over.")),
  ...
  async execute(interaction: CommandInteraction) {
    ...
    const embed = new EmbedBuilder().setColor(colour).setAuthor(getAuthorData(interaction));
