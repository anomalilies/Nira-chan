...
global.contest1 = new Discord.MessageEmbed()
    ...
    .addFields({
        ...
        value:
            "You've probably already guessed the theme of this contest from the subheader above, and as such, our monthly contest has expanded from having a sole focus on art, to allowing a ton of potential options to its entrants.\nWhether you still want to focus on drawing, make a cover of a previous song, or write a whole thesis on ZUTOMAYO lore, the possibilities are ~~somewhat~~ endless!"
    });
...
global.contest4 = new Discord.MessageEmbed().setColor(15849719).addFields({
