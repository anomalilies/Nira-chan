...
global.links2 = new Discord.MessageEmbed().setTitle("Scans").setColor(15849719).addFields(
    {
...
global.links3 = new Discord.MessageEmbed().setTitle("Music").setColor(15849719).addFields(
