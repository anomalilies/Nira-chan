...
global.links1 = new Discord.MessageEmbed()
  ...
  .addFields(
    ...
    {name: "FUJI ROCK FESTIVAL 2019", value: "**[Download Link](https://mega.nz/file/rXQB0arY#O5IoHE1kre58krNLoO_qKQ3TcNc1xKa12hr_vqx87oM)** ([Mirror](https://drive.google.com/file/d/1awTe-vcZrqK5gJWmM0SgDjQgL057CNsW/view?usp=sharing))\nAudio-only: [MP3](https://drive.google.com/drive/folders/1wsBOIe4zt8RYKyY5e9-TZ4kdCkcJBVeL?usp=sharing)"},
    {name: "ACAね Before ZUTOMAYO in 2017", value: "**[Download Link](https://mega.nz/file/nepkHapA#IFHNIUGdDif17297t8sVfwaYYifvoEotU3ogWl8aVaM)**"}
);
global.links2 = new Discord.MessageEmbed()
  .setTitle("Scans")
  .setColor(15849719)
  .addFields(
    {name: "Hisohiso Banashi: Band Score", value: "**[Download Link](https://drive.google.com/drive/folders/1iyKuqs4dfOoYcRAlKvAnbgWCVU_DK5En?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/1vkVTM5w-ftEit4f138YSqpE7NamEc9r4?usp=sharing))"},
    {name: "Hisohiso Banashi: Limited Edition Booklet", value: "**[Download Link](https://drive.google.com/drive/folders/16Qljz7LZk2rOAA9vZNRkBjZv7f5KwQJm?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/1IZeEG3gJuHpDTZbLD2z9ph_nx8dB5ese?usp=sharing))"},
    {name: "Hogaraka na Hifutote Fufuku: Limited Edition Booklet", value: "**[Download Link](https://drive.google.com/drive/folders/1VzqAAmpBZ96iMiO3dcw9HnhbErng985u?usp=sharing)** ([Mirror](https://drive.google.com/drive/folders/18WlEyI6q1FPvkrZf8oCVUIkb0Lh8zDv8?usp=sharing))"}
);
global.links3 = new Discord.MessageEmbed()
  .setTitle("Music")
  .setColor(15849719)
  .addFields(
    {name: "Official Instrumentals", value: "**[Download Link](https://piapro.jp/zutomayo)**"},
    {name: "ACAね's Song Covers", value: "**[Download Link](https://drive.google.com/drive/folders/1k6SJ4cH4CGEbbIIA-jIw2t47ebUi-dwl?usp=sharing)**"},
    {name: "ZUTOMAYO Complete Playlist", value: "**[Spotify Link](https://open.spotify.com/playlist/4LzgxjNXi3YgYHje06rQDr?si=cRIvxONUSICOenB5EJjVgQ)**"}
);