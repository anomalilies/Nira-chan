...
global.roles3 = new Discord.MessageEmbed()
    ...
    .addFields(
        ...
        {
            name: "Regulars",
            value: `The <@&751209585464836137> role is given to our most active users on a weekly basis.`
        },
        {
            name: "Musicians",
        ...
        {
            name: "Hackers",
            value: `Our <@&769728601036947467> provide invaluable help with developing and debugging <@740606402330099752>.`
        },
        {
            name: "Journalists",
...
global.roles4 = new Discord.MessageEmbed()
    ...
    .addFields(
        {
            name: "h̷͂̒ē̶̓ ̶͂͝w̴̍̆h̶͛̉o̵͒̍ ̵̑̄s̸̛͝h̵̑̃a̵͂͆l̶̘̋l̶̋̕ ̷̌̍n̶̽͠ŏ̴̚ť̵̍ ̸͋̊b̵̔̅é̷̩ ̵̒͂n̸̈́͠ȃ̴̈́ṁ̴̺e̴̿͝d̷͛͐",
            value: `We don't know why we gave this to <@208960237988741123>, either.`
        },
        ...
        {
            name: "Fisherban",
            value: `A role created from an inside-joke, born from the rivalry seen in <#747201864889794721>.`
        },
