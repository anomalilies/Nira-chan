...
global.bc3 = new Discord.MessageEmbed().setTitle("🎰 | Gambling").setColor(15849719).addFields(
    {
        name: "Blackjack",
        value:
            "The aim of blackjack is to beat the dealer's hand, without going over 21, and with the least amount of cards.\nPlay a Game: `blackjack <bet>` | Example: `!blackjack 100`\n\nTake Another Card: `hit`\nSkip a Turn: `stand`\nDouble Your Bet, and Take Another Card: `double down`\nSplit into Two Hands: `split`"
    },
    {
        name: "Roulette",
        value:
...
global.bc4 = new Discord.MessageEmbed().setTitle("🔨 | Tools and Utilities").setColor(15849719).addFields(
...
global.bc5 = new Discord.MessageEmbed().setTitle("🎉 | Fun and Games").setColor(15849719).addFields(
...
global.bc6 = new Discord.MessageEmbed().setColor(15849719).addFields(
...
global.bc8 = new Discord.MessageEmbed()
    ...
    .addFields(
        ...
        { name: "Add Bot to the VC", value: "`join/j`" },
        {
            ...
            value:
                "Available sounds can be found using: `soundboard`\nTo play a sound, use `sb [name]`\nExample: `-sb bruh`"
        }
    );
