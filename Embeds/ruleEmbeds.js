...
global.rule3 = new Discord.MessageEmbed()
  ...
  .addFields(
    {name: "Moderation", value: "1. Our auto-moderation measures will temporarily mute any user who has posted 5 times within 2 seconds.\n2. If behaviour continues, the user will be kicked, or permanently banned if necessary/they are thought to be a bot."}
)
...
global.rule5 = new Discord.MessageEmbed()
  ...
  .addFields(
    {name: "Moderation", value: "1. Moderators and Admins will attempt to move conversations to their designated, or otherwise suitable, channel whenever necessary."}
)
...
global.rule8 = new Discord.MessageEmbed()
  ...
  .addFields(
    {name: "Moderation", value: "1. If a user is thought to be adding a negative influence to the server (i.e: being manipulative and critical of others, putting them down, and being immune to abstract thinking, etc.), the Moderation team will contact them directly about their behaviour, as to give them an opportunity to learn and change.\n2. However. if behaviour continues, they face the risk of being muted, kicked, or banned, depending on each individual circumstance."}
)
