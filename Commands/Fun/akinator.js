...
module.exports = class AddCommand extends Commando.Command {
    ...
    async run(message) {
        if (message.channel.type === "dm" || allowlists.botspamchannels.includes(message.channel.id) || message.member.roles.cache.get(zoneRoles.botPass)) {
            ...
            const dimeloEmbed = getSimpleEmbed (
                ...
                "https://raw.githubusercontent.com/anomalilies/Nira-chan/master/Images/Dimelo_Tony.png"
            );
